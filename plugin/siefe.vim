...
command! -nargs=* -bang SiefeBuffersRg call siefe#ripgrepfzf(<q-args>, siefe#bufdir(), siefe#get_git_basename_or_bufdir(), 0, 0, 0, 0, 0, siefe#bufdir(), "", map(filter(copy(getbufinfo()), 'v:val.listed'), 'v:val.name'), <bang>0)
