...
command! -nargs=* -bang Gp    call siefe#gitlogfzf(<q-args>, [], [], [], 0, 0, [], 0, 0, <bang>0)
command! -nargs=* -bang Gv    call siefe#gitlogfzf(siefe#visual_selection(), [], [], [], 0, 0, [], 0, 0, <bang>0)
command! -nargs=* -bang GWord call siefe#gitlogfzf(expand("<cword>"), [], [], [], 0, 0, [], 0, 0, <bang>0)
command! -nargs=* -bang GWORD call siefe#gitlogfzf(expand("<cWORD>"), [], [], [], 0, 0, [], 0, 0, <bang>0)
command! -nargs=* -bang Gline call siefe#gitlogfzf(expand("<cword>"), [], [], [], 0, 0, [], 0, 0, <bang>0)
